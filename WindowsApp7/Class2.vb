...
Class TwitchTheme
    ...
    Protected Overrides Sub PaintHook()
        ...
        G.FillRectangle(New SolidBrush(Color.FromArgb(19, 23, 34)), New Rectangle(0, 0, Width, 30))
        'G.FillRectangle(New SolidBrush(Color.FromArgb(19, 23, 34)), New Rectangle(0, 30, 10, Height - 30))
        'G.DrawLine(Pens.Black, Width - 11, 30, Width - 10, Height - 30)
        G.FillRectangle(New SolidBrush(Color.FromArgb(19, 23, 34)), New Rectangle(Width - 10, 30, 10, Height - 30))
        'G.DrawLine(Pens.Black, 10, Height - 11, Width - 10, Height - 11)
        G.FillRectangle(New SolidBrush(Color.FromArgb(19, 23, 34)), New Rectangle(0, Height - 10, Width, 10))
        DrawCorners(Color.Fuchsia)
        G.DrawString(FindForm.Text, Font, Brushes.White, 5, 6)
        If Fill = True Then
            G.FillRectangle(New SolidBrush(Color.FromArgb(19, 23, 34)), New Rectangle(0, 0, Width, Height))
            DrawCorners(Color.Fuchsia)
            G.DrawString(FindForm.Text, Font, Brushes.White, 5, 6)
        End If
    End Sub
...
Class TwitchCollapseBox
    ...
    Sub New()
        ...
        Cursor = Cursors.Hand
        AddHandler Click, AddressOf BoxClicked
...
#End Region
    ...
    Sub New()
        ...
        Size = sw
        AddHandler Click, AddressOf Clicked
        Transparent = True
